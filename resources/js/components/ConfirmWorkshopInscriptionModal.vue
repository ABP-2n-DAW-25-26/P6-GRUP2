...
<template>
    ...
    >
        ...
        >
            ...
            >
                <div class="h-1.5 bg-gradient-to-r from-[#01617F] to-[#0a7494]"></div>

                <div class="flex items-start gap-4 px-6 pt-6 sm:px-8">
                    <span
                        class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#01617F]/10 text-[#01617F]"
                    >
                        <svg
                            class="h-6 w-6"
                            viewBox="0 0 24 24"
                ...
                <div class="px-6 py-5 sm:px-8">
                    <dl class="divide-y divide-slate-100 rounded-xl bg-slate-50 ring-1 ring-slate-200/60">
                        ...
                        <div class="grid grid-cols-3 gap-4 px-4 py-3">
                            ...
                            <dd class="col-span-2 break-all text-sm text-slate-900">
                                {{ email }}
                            </dd>
                        </div>
                        <div class="grid grid-cols-3 gap-4 px-4 py-3">
                    ...
                    >
                        ...
                        Un cop inscrit/a, rebràs una confirmació al teu correu electrònic.
                    </p>
                </div>
                ...
                >
                    ...
                    <button
                        type="button"
                        :disabled="isSubmitting"
                        class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-br from-[#01617F] to-[#004e66] px-5 py-2 text-sm font-semibold text-white shadow-md shadow-[#01617F]/20 transition hover:shadow-lg hover:shadow-[#01617F]/30 disabled:opacity-50"
                        @click="emit('confirm')"
                    >
                        <svg
                            v-if="isSubmitting"
                        ...
                        {{ isSubmitting ? 'Enviant…' : 'Sí, inscriure\'m' }}
                    </button>
                </div>
            </div>
        </div>
