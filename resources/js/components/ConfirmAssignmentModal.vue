            ...
            >
                ...
                <div class="px-6 py-5 sm:px-8">
                    ...
                    >
                        ...
                        <div class="grid grid-cols-3 gap-4 px-4 py-3">
                            ...
                            <dd class="col-span-2 text-sm whitespace-pre-line [overflow-wrap:anywhere] text-slate-900">
                                {{ description }}
                            </dd>
                        </div>
                    </dl>
                    ...
                    >
                        ...
                        Un cop enviat, rebràs una confirmació al teu correu electrònic.
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        {{ isSubmitting ? 'Enviant…' : 'Sí, enviar' }}
                    </button>
                </div>
            </div>
        </div>
